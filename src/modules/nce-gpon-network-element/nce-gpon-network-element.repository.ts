...
@Injectable()
export class NceGponNetworkElementRepository extends BaseAbstractRepository<NceGponNetworkElement> {
  constructor(
    @InjectRepository(NceGponNetworkElement)
    private readonly neRepository: Repository<NceGponNetworkElement>,
